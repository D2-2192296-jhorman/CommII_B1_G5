...
class P_4_Prueba1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Practica_4", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Practica_4")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "P_4_Prueba1")
...
def main(top_block_cls=P_4_Prueba1, options=None):
